...
FilamentManager.prototype.viewModels.profiles = function profilesViewModel() {
    ...
    self.fromProfileData = function setLoadedProfileFromJSObject() {
        ...
        self.loadedProfile.profile_notes(data.profile_notes);
    };
    ...
    self.toProfileData = function getLoadedProfileAsJSObject() {
        ...
        return {
            ...
            profile_notes: self.loadedProfile.profile_notes()
        };
    };
...
FilamentManager.prototype.viewModels.selections = function selectedSpoolsViewModel() {
    ...
    // Added 7/13/2020 --SFAL
    self.getProfileNotes = function getProfileNotes(index) {
        if (index < self.selectedSpools().length) {
            var spool = self.selectedSpools()[index];
            return spool ? spool.profile.profile_notes : '';
        }
        return '';
    };
};
